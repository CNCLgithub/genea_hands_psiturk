class Page {
    ...
    constructor() {
        this.generic_page = document.getElementById("generic_section");
        ...
        this.quiz_section = document.getElementById("quiz_section");
        this.questionnaire_section = document.getElementById("questionnaire_section");

        this.all_section = []
        this.#addSectionToPage(this.generic_page);
        this.#addSectionToPage(this.instruction_section);
        this.#addSectionToPage(this.trials_section);
        this.#addSectionToPage(this.quiz_section);
        this.#addSectionToPage(this.questionnaire_section);
    }
    ...
    showGeneric() {
        this.#toggleSectionAsVisible(this.generic_page);
    }
    ...
    showQuiz() {
        this.#toggleSectionAsVisible(this.quiz_section);
    }

    showQuestionnaire() {
        this.#toggleSectionAsVisible(this.questionnaire_section);
    }
}
